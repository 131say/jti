...
- Gears (schema 3.2): base_shape "gear". parameters: module (mm), teeth (integer >= 4), thickness (mm), bore_diameter (mm), high_lod optional boolean default false. Preview mode (high_lod false): lightweight polygon gear for fast CAD; do not set high_lod true — involute manufacturing mode is reserved for a future release.
